<h2>Macroeconomics<img src="<?php echo url(); ?>images/menu/Money.png" alt="Money"></h2>
<div class="calculate" id="calculate">
    ...
    <p><label>Short FRQ1 Score (%)</label></p>
      <p><input type="range" id="SRQ1" min="0" step="1" max="100" onmouseup="slidervalue('SRQ1','SRQ11'), calculate();" ontouchend="slidervalue('SRQ1','SRQ11'), calculate();"/><input type="number" min="0" max="100" step="1" id="SRQ11" value="50" onchange="slidervalue('SRQ11','SRQ1'), calculate();"/>/100</p>
    <p><label>Short FRQ2 Score (%)</label></p>
      <p><input type="range" id="SRQ2" min="0" step="1" max="100" onmouseup="slidervalue('SRQ2','SRQ22'), calculate();" ontouchend="slidervalue('SRQ2','SRQ22'), calculate();"/><input type="number" min="0" max="100" step="1" id="SRQ22" value="50" onchange="slidervalue('SRQ22','SRQ2'), calculate();"/>/100</p>
