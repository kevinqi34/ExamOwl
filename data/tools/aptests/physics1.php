<h2>Physics 1<img src="<?php echo url(); ?>images/menu/Physics.png" alt="Physics"></h2>
<div id="calculate" class="calculate" >
    ...
    <p><label>Short Free Response Score</label></p>
      <p><input type="range" id="SFRQ" min="0" step="1" max="21"  onmouseup="slidervalue('SFRQ','SFRQ1'), calculate();" ontouchend="slidervalue('SFRQ','SFRQ1'), calculate();"/><input type="number" min="0" max="21" step="1" id="SFRQ1" value="10"  onchange="slidervalue('SFRQ1','SFRQ'), calculate();"/>/21</p>
