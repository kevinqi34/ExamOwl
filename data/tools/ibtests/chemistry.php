<h2>Chemistry HL<img src="<?php echo url(); ?>images/menu/Science.png" alt="Science"></h2>
	...
	<div id="calculate" class="calculate">
		<h3>Enter your scores below</h3>
			...
			<p><label>Paper 2 Score</label></p>
				<p><input type="range" id="P2" min="0" step="1" max="90" onmouseup="slidervalue('P2','P22'), calculate();" ontouchend="slidervalue('P2','P22'), calculate();"/><input type="number" min="0" max="90" step="1" id="P22" value="36"  onchange="slidervalue('P22','P2'), calculate();"/>/90</p>
			<p><label>Paper 3 Score</label></p>
				<p><input type="range" id="P3" min="0" step="1" max="50" onmouseup="slidervalue('P3','P33'), calculate();" ontouchend="slidervalue('P3','P33'), calculate();"/><input type="number" min="0" max="50" step="1" id="P33" value="20"  onchange="slidervalue('P33','P3'), calculate();"/>/50</p>
