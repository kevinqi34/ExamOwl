<h2>Economics HL/SL<img src="<?php echo url(); ?>images/menu/Money.png" alt="Money"></h2>
	...
	<div id="calculate" class="calculate">
    	<h3>Enter your scores below</h3>
			<p><label>Paper 1 Score</label></p>
				<p><input type="range" id="P1" min="0" step="1" max="25" onmouseup="slidervalue('P1','P11'), calculate();" ontouchend="slidervalue('P1','P11'), calculate();"/><input type="number" min="0" max="30" step="1" id="P11" value="12"  onchange="slidervalue('P11','P1'), calculate();"/>/25</p>
			<p><label>Paper 2 Score</label></p>
				<p><input type="range" id="P2" min="0" step="1" max="30" onmouseup="slidervalue('P2','P22'), calculate();" ontouchend="slidervalue('P2','P22'), calculate();"/><input type="number" min="0" max="30" step="1" id="P22" value="15"  onchange="slidervalue('P22','P2'), calculate();"/>/30</p>
