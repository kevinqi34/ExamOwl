<h2>Physics HL<img src="<?php echo url(); ?>images/menu/Mechanics.png" alt="Mechanics"></h2>
	...
	<div id="calculate" class="calculate">
    	<h3>Enter your scores below</h3>
			...
			<p><label>Paper 2 Score</label></p>
				<p><input type="range" id="P2" min="0" step="1" max="95" onmouseup="slidervalue('P2','P22'), calculate();" ontouchend="slidervalue('P2','P22'), calculate();"/><input type="number" min="0" max="95" step="1" id="P22" value="47"  onchange="slidervalue('P22','P2'), calculate();"/>/95</p>
