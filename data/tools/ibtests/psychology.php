<h2>Psychology HL/SL<img src="<?php echo url(); ?>images/menu/Brain.png" alt="Brain"></h2>
	...
	<div id="calculate" class="calculate">
			...
			<p><label>Paper 1 Score</label></p>
				<p><input type="range" id="P1" min="0" step="1" max="52" onmouseup="slidervalue('P1','P11'), calculate();" ontouchend="slidervalue('P1','P11'), calculate();"/><input type="number" min="0" max="52" step="1" id="P11" value="26"  onchange="slidervalue('P11','P1'), calculate();"/>/52</p>
			...
			<p><label>Paper 3 Score</label></p>
				<p><input type="range" id="P3" min="0" step="1" max="30" onmouseup="slidervalue('P3','P33'), calculate();" ontouchend="slidervalue('P3','P33'), calculate();"/><input type="number" min="0" max="30" step="1" id="P33" value="15"  onchange="slidervalue('P33','P3'), calculate();"/>/30</p>
			<p><label>Internal Score</label></p>
				<p><input type="range" id="IS" min="0" step="1" max="25"onmouseup="slidervalue('IS','IS2'), calculate();" ontouchend="slidervalue('IS','IS2'), calculate();"/><input type="number" min="0" max="25" step="1" id="IS2" value="12"  onchange="slidervalue('IS2','IS'), calculate();"/>/25</p>
