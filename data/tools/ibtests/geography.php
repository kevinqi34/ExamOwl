<h2>Geography HL/SL<img src="<?php echo url(); ?>images/menu/Globe.png" alt="Globe"></h2>
	...
	<div id="calculate" class="calculate">
      	<h3>Enter your scores below</h3>
			<p><label>Paper 1 Score</label></p>
				<p><input type="range" id="P1" min="0" step="1" max="50" onmouseup="slidervalue('P1','P11'), calculate();" ontouchend="slidervalue('P1','P11'), calculate();"/><input type="number" min="0" max="50" step="1" id="P11" value="25"  onchange="slidervalue('P11','P1'), calculate();"/>/50</p>
			<p><label>Paper 2 Score</label></p>
				<p><input type="range" id="P2" min="0" step="1" max="80" onmouseup="slidervalue('P2','P22'), calculate();" ontouchend="slidervalue('P2','P22'), calculate();"/><input type="number" min="0" max="80" step="1" id="P22" value="40"  onchange="slidervalue('P22','P2'), calculate();"/>/80</p>
			<p><label>Internal Score</label></p>
				<p><input type="range" id="IS" min="0" step="1" max="30"onmouseup="slidervalue('IS','IS2'), calculate();" ontouchend="slidervalue('IS','IS2'), calculate();"/><input type="number" min="0" max="30" step="1" id="IS2" value="15"  onchange="slidervalue('IS2','IS'), calculate();"/>/30</p>
	...
	<div id="calculate2" class="calculate" style="display: none">
    	...
    	<h3>Enter your scores below</h3>
			...
			<p><label>Paper 2 Score</label></p>
				<p><input type="range" id="P2SL" min="0" step="1" max="60" onmouseup="slidervalue('P2SL','P22SL'), calculate2();" ontouchend="slidervalue('P2SL','P22SL'), calculate2();"/><input type="number" min="0" max="60" step="1" id="P22SL" value="30"  onchange="slidervalue('P22SL','P2SL'), calculate2();"/>/60</p>
			<p><label>Internal Score</label></p>
