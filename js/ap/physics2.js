...
function calculate() {
	var a = parseInt(document.getElementById('MC').value);
		...
		var score1 = Math.round(((45/50) * a)*100)/100;
				score2 = Math.round((b + c + 1)*100)/100;
		...
		var percent = Math.round((score3/90)*100);
			...
			if (d == true) {
			if(score3 >= 0 && score3 <= 21) {
				 score4 = 1;
				}
			else if(score3 > 21 && score3 <= 38) {
				 score4 = 2;
				}
			else if(score3 > 38 && score3 <= 55) {
				 score4 = 3;
				}
			else if(score3 > 55 && score3 <= 66) {
				 score4 = 4;
				}
			else if(score3 > 66 && score3 <= 90) {
				 score4 = 5;
				}
		}
