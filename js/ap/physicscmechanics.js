...
function calculate() {
	...
	var score4;
		...
		if (e == true) {
			...
			else if(score3 > 22 && score3 <= 30) {
				 score4 = 2;
				}
			else if(score3 > 30 && score3 <= 38) {
				 score4 = 3;
				}
			else if(score3 > 38 && score3 <= 49) {
				 score4 = 4;
				}
			else if(score3 > 49 && score3 <= 90) {
				 score4 = 5;
				}
		}
	if (f == true) {
		...
		if (score3 > 22 && score3 <= 31) {
			score4 = 2;
			}
		if (score3 > 31 && score3 <= 40) {
			score4 = 3
			}
		if (score3 > 40 && score3 <= 51) {
			score4 = 4;
			}
		if (score3 > 51 && score3 <= 90) {
			score4 = 5;
			}
	}
