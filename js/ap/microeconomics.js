...
function calculate() {
	...
	var score4;
		...
		if (e == true) {
			if(score3 >= 0 && score3 <= 38) {
				 score4 = 1;
				}
			else if(score3 > 38 && score3 <= 49) {
				 score4 = 2;
				}
			else if(score3 > 49 && score3 <= 61) {
				 score4 = 3;
				}
			else if(score3 > 61 && score3 <= 74) {
				 score4 = 4;
				}
			else if(score3 > 74 && score3 <= 90) {
				 score4 = 5;
				}
		}
	if (f == true) {
		...
		if (score3 > 34 && score3 <= 46) {
			score4 = 2;
			}
		if (score3 > 46 && score3 <= 57) {
			score4 = 3
			}
		if (score3 > 57 && score3 <= 72) {
			score4 = 4;
			}
		if (score3 > 72 && score3 <= 90) {
			score4 = 5;
			}
	}
