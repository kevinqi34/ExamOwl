function calculate() {
	...
	var percent = Math.round((score1/100)*100);	
		...
		if (g == true && e == true) {
			...
			else if(score1 > 12 && score1 <= 27) {
				 score2 = 2;
				}
			else if(score1 > 27 && score1 <= 41) {
				 score2 = 3;
				}
	...
	if (g == true && f == true) {
			...
			else if(score1 > 28 && score1 <= 40) {
				 score2 = 3;
				}
			else if(score1 > 40 && score1 <= 54) {
				 score2 = 4;
				}
			else if(score1 > 54 && score1 <= 67) {
				 score2 = 5;
				}
			else if(score1 > 67 && score1 <= 80) {
				 score2 = 6;
				}
