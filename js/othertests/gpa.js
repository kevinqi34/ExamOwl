...
function gpa3() {
	...
	/*
		...
		function gpa4() {
				var a = document.getElementById('CGPA12').value;
				var b = document.getElementById('CGPA13').value;
				var c = document.getElementById('CGPA14').value;
				var d = document.getElementById('CGPA15').value;
				var e = document.getElementById('CGPA16').value;
				var f = document.getElementById('CGPA17').value;
				var g = document.getElementById('CGPA18').value;
				var h = document.getElementById('CGPA19').value;
				var i = document.getElementById('CGPA20').value;
				var j = document.getElementById('CGPA21').value;
				var k = document.getElementById('CGPA22').value;
				var l = document.getElementById('CGPA23').value;
				var m = document.getElementById('CGPA24').value;
			//	var n = document.getElementById('STD3').value;
